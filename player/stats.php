                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-calendar'></i> Your Statistics
                            <small>
                                View your statistics for the current season.
                            </small>
                        </h1>
                    </div>
                    <!-- Your main content goes below here: -->
                    <?php
                        include '../templates/partials/player/passing_stats.php';
                        include '../templates/partials/player/rushing_stats.php';
                        include '../templates/partials/player/receiving_stats.php';
                    ?>
                </main>
