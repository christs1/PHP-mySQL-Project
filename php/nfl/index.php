                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2">CPSC 431</span>
                        </a>
                    </div>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="img/profile-pics/andy_reid.jpeg" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <li class="active">
                                <a href="blank.html" title="Blank Project" data-filter-tags="blank page">
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.blankpage">My Team</span>
                                </a>
                            </li>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="img/profile-pics/andy_reid.jpeg" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-globe'></i> My Team <span class='fw-300'>Manage</span> <sup class='badge badge-primary fw-500'>COACH</sup>
                                <small>
                                    Manage your team
                                </small>
                            </h1>
                            ...
                            <div class="d-flex flex-start w-100">
                                ...
                                <div class="d-flex flex-fill">
                                    <div class="flex-fill">
                                        ...
                                        <p>
                                        If you're navigating our team management system for the first time, start here. This page provides essential tools and resources to 
                                        help you set up your account, access key performance indicators (KPIs), and track player developments.

                                        Utilize our intuitive dashboard with a "Coaching Insights" module, featuring data-driven analytics to inform your decision-making. A 
                                        helpful guide is available on the left, including step-by-step tutorials and frequently asked questions.
                                        </p>
                                        <p class="m-0">
                                        Follow our <a href="#" target="_blank">"Team Development Plan"</a> call-to-action button for more information and to access exclusive resources tailored to your 
                                        coaching needs.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Panel <span class="fw-300"><i>Roster Management</i></span>
                                        </h2>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <div class="panel-tag">
                                            Get an inside look at your team's roster with our intuitive player management system. Easily track player stats, skills, and 
                                            performances to make informed decisions about lineup changes, trades, and draft picks.
                                            </div>
                                            <p>Access data-driven analytics and trends to inform your coaching strategy. To maximize its impact, navigate to the "Trend Analysis" tab and view the historical performance data on offense, defense, and special 
                                            teams. Compare this week's opponent with previous matchups to identify patterns and areas for exploitation. Click on the "Strength of 
                                            Schedule" filter to isolate key statistics such as yards per play, points allowed, and turnover margin. Use these insights to inform 
                                            your in-game adjustments and make data-driven decisions at the line of scrimmage.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Panel <span class="fw-300"><i>Reviewing this week's game plan</i></span>
                                        </h2>
                                        <div class="panel-toolbar">
                                            <button class="btn btn-panel" data-action="panel-collapse" data-toggle="tooltip" data-offset="0,10" data-original-title="Collapse"></button>
                                            <button class="btn btn-panel" data-action="panel-fullscreen" data-toggle="tooltip" data-offset="0,10" data-original-title="Fullscreen"></button>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <p>"Reviewing this week's game plan, please click on 'Player Projections' and adjust the expected production numbers based on last game's 
                                            performance. Under 'Injury Report', update the status of [Player Name] to 'Out' and add [Player Name]'s backup as a substitute in the 
                                            lineup. In the 'Game Script' section, review the play call data for this week's matchup and make any necessary adjustments to the 
                                            running game scheme. Additionally, click on 'Defensive Scouting Report' to review the opponent's tendencies and make recommendations 
                                            for defensive package deployment."
                                            </p>
                                        </div>
                                    </div>
                                </div>
